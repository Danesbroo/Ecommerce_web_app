...
export default function SidebarFilter() {
  ...
  useEffect(() => {
    axios
      .post("http://localhost:4000/api/website/nested-category/view")
  ...
  useEffect(() => {
    axios
      .post("http://localhost:4000/api/website/material/view")
  ...
  useEffect(() => {
    axios
      .post("http://localhost:4000/api/website/color/view")
